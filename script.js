let wheel_1, wheel_2, wheel_3, wheel1, wheel2, wheel3, secretNumber1, secretNumber2, secretNumber3, attempts;
...
function checkImage() {
    if (wheel1 === secretNumber1 && wheel2 === secretNumber2 && wheel3 === secretNumber3) {
...
function init() {
    ...
    updateAttempts(attempts);
    console.log('new button pressed: ' + secretNumber1, secretNumber2, secretNumber3);
    ...
    document.getElementById('hintButton').onclick = function () {
        document.getElementById('hintText').style.display === 'block' ? document.getElementById('hintText').style.display = 'none' : document.getElementById('hintText').style.display = 'block';
    };
};
